...
def search_send_jobs(sub_id,keywords,sites):
  ...
  for keyword in keywords:
    ...
    if 'sudancareers' in sites:
      ...
      if jobs_list != '':
        try:
          bot.send_message(sub_id,jobs_list,parse_mode = "html",disable_web_page_preview=True)
        except :
  ...
  bot.send_message(sub_id,'To unsubscribe from weekly report\nsend /Unsubscribe\nto change watch list please\nsend /Change')      
